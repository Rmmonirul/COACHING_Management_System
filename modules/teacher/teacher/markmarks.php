           ...
           foreach ($_POST['marksobtain'] as $sid_get => $marksobtain_get){
               ...
               if($insert_check_check_result > 0){
                   ...
                   if($examdate_get == $row['dateofexam']) {
                       $insert_query = "INSERT INTO marks (sid,subject,examname,marksobtain,totalmarks,eid,batch,dateofexam) VALUES ('$sid_get','$subject','$examname_get','$marksobtain_get','$marks_get','$eid_insert','$batch_get','$examdate_get')";
